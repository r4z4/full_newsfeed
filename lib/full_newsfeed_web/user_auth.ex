defmodule FullNewsfeedWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule FullNewsfeedWeb.PageLive do
        use FullNewsfeedWeb, :live_view

        on_mount {FullNewsfeedWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{FullNewsfeedWeb.UserAuth, :ensure_authenticated}] do

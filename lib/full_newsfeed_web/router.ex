defmodule FullNewsfeedWeb.Router do
  use FullNewsfeedWeb, :router

  import FullNewsfeedWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {FullNewsfeedWeb.Layouts, :root}
  ...
  # scope "/api", FullNewsfeedWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:full_newsfeed, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FullNewsfeedWeb.Telemetry
  ...
  scope "/", FullNewsfeedWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FullNewsfeedWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FullNewsfeedWeb do
    ...
    live_session :current_user,
      on_mount: [{FullNewsfeedWeb.UserAuth, :mount_current_user}] do

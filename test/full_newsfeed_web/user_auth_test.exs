defmodule FullNewsfeedWeb.UserAuthTest do
  use FullNewsfeedWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias FullNewsfeed.Account
  alias FullNewsfeedWeb.UserAuth
  import FullNewsfeed.AccountFixtures

  @remember_me_cookie "_full_newsfeed_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FullNewsfeedWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FullNewsfeedWeb.Endpoint.subscribe(live_socket_id)
